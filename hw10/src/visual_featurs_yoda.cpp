...
int main(int argc, char** argv)
{
	...
	surfer->detect(img_scene, keypoints_scene);

	//-- Step 2: Calculate descriptors (feature vectors)
	Mat descriptors_object, descriptors_scene;
	surfer->compute(img_object, keypoints_object, descriptors_object);
	surfer->compute(img_scene, keypoints_scene, descriptors_scene);
